...
let addGameBtn = document.querySelector('#save_changes');
let resetGameBtn = document.querySelector('#reset_changes');
...
/* RESET CHECKBOXES ON RESET CLICK */
resetGameBtn.addEventListener('click', function(){
    document.querySelectorAll('.custom-checkbox').forEach(
        (checkbox) => checkbox.classList.remove('checked')
    );
    
    genresCheckboxes.forEach((checkbox) => checkbox.setAttribute('value', 'false'));
    featuresCheckboxes.forEach((checkbox) => checkbox.setAttribute('value', 'false'));
});
...
addGameBtn.addEventListener('click',   function (e) {
    ...
    $.ajax({
        type: 'post',
        url: '/games-management/save-added-game',
        data: ajaxData,
        dataType: 'text',
